...
public class FullInfoNonSplitReader_cache<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
    IReader<Writable, Writable, Writable, Writable, S, V, E, LongWritable, LongWritable, LongWritable> {

  public static final Log LOG = LogFactory.getLog(FullInfoNonSplitReader_cache.class);
  ...
  public FullInfoNonSplitReader_cache(
  ...
  private void createVertex(String stringInput) {
    ...
    subgraph.addVertex(createVertexInstance(vertexID, _adjList), isBoundary);
  }
